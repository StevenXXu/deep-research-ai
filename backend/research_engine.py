...
class ResearchEngine:
    ...
    def phase_audit_consistency(self):
        ...
        audit_prompt = prompts_config.AUDIT_PROMPT_TEMPLATE.format(company=self.company, url=self.url, source_list_json=json.dumps(source_list, indent=2))
    ...
    def phase_4_synthesis(self):
        ...
        prompt_agent1 = prompts_config.AGENT_1_PROMPT_TEMPLATE.format(company=self.company, domain=self.domain, identity_anchor=identity_anchor, context_blob=context_blob)
        ...
        prompt_agent2 = prompts_config.AGENT_2_PROMPT_TEMPLATE.format(company=self.company, facts_json=facts_json)
        ...
        prompt_agent3 = prompts_config.AGENT_3_PROMPT_TEMPLATE.format(company=self.company, domain=self.domain, identity_anchor=identity_anchor, formatting_payload=formatting_payload)
